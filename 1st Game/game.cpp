...
simulate_game(Input* input, float dt) {
	...
	if (current_gamemode == GM_GAMEPLAY) {
		...
		//Rendering
		draw_rect(ball_p_x, ball_p_y, 1.5, 1.5, 0xffffff);
		...
		draw_text("GAMEMODE", -22, 5, 1, 0xffffff);
		...
		if (hot_button == 0) {
			draw_rect(-20, -20, 12, 12, 0xffffff);
			draw_rect(20, -20, 10, 10, 0xffffff);
		}
		else {
			draw_rect(-20, -20, 10, 10, 0xffffff);
			draw_rect(20, -20, 12, 12, 0xffffff);
		...
		draw_text("PONG", -30, 35, 3, 0xffffff);

		draw_text("A", -21, -17, 1, 0x000000);
		draw_text("B", 19, -17, 1, 0x000000);
